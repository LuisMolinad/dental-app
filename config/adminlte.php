...
return [
    ...
    */
    ...
    'preloader' => [
        ...
        'img' => [
            'path' => './img/icono1.png',
            'alt' => 'dental-app Preloader Image',
        ...
        'Datatables' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/datatables/css/responsive.dataTables.min.css',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => 'vendor/datatables/js/jquery-3.7.0.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
        ...
        'Bootstrap' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => '//cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css',
                ],
            ],
        ],
        'FullCalendar' => [
